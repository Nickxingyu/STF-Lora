...
class WACNNWithLora(WACNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.h_a = nn.Sequential(
            lora_conv3x3(320, 320, lora_r=16, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(320, 288, lora_r=16, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(
        ...
        self.h_mean_s = nn.Sequential(
            ...
            nn.GELU(),
            lora_subpel_conv3x3(256, 288, 2, lora_r=16, merge_weights=merge_weights),
            nn.GELU(),
