...
class WACNNWithLora(WACNN):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.h_a = nn.Sequential(
            lora_conv3x3(320, 320, lora_r=8, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(320, 288, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(288, 256, lora_r=4, merge_weights=merge_weights, stride=2),
            nn.GELU(),
            lora_conv3x3(256, 224, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(224, 192, lora_r=4, merge_weights=merge_weights, stride=2),
        )

        self.h_mean_s = nn.Sequential(
            lora_conv3x3(192, 192, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_subpel_conv3x3(192, 224, 2, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(224, 256, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_subpel_conv3x3(256, 288, 2, lora_r=4, merge_weights=merge_weights),
            nn.GELU(),
            lora_conv3x3(288, 320, lora_r=8, merge_weights=merge_weights),
        )
